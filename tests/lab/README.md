...
| `checkout.lab.mjs` | PR1e con Stripe simulado: URL de retorno fijas, 30 peticiones simultáneas con límite de 10, límite por email (en hash), interruptor, otra web bloqueada, permisos. |
